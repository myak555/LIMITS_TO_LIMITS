...
ax1.plot( Prediction_T, Prediction_Total_Hughes, ".", lw=1, color="r", label="Hughes (2016), URR={:.1f} трлн м³".format(np.sum(Prediction_Total_Hughes)/1000+34.2))
...
ax1.plot( Year, Total, "-", lw=2, color="r", label="Laherrer (2014)")
...
ax2.plot( Year, Cum_Total/1000, "-", lw=2, color="r", label="Весь газ, Laherrer (2014), URR={:.1f} трлн м³".format(np.sum(Total)/1000))
