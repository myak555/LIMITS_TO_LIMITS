...
name = "Иглфорд"
data_name = "./Data/US04_EagleFord_Gas.csv"
metric = True
...
YC,PC = Load_Calibration( "./Data/US12_US_Tight_Gas_EIA.csv", "Year", "EagleFord")
...
if metric:
    ...
    ax1.annotate("Пик добычи в сентябре 2015", xy=(2015, 61), xytext=(2001, 61), arrowprops=dict(facecolor='black', shrink=0.05))
else:
...
plt.savefig( ".\\Graphs\\figure_11_04.png")
fig.show()
