...
Y_BP1 = np.linspace( 1994, 2016, 23)
P_BP1 = np.array( [533.0,526.7,533.9,535.3,538.7,533.3,543.2,555.5,536.0,540.8,526.4,511.1,524.0,545.6,570.8,584.0,603.6,648.5,680.5,685.4,733.1,766.2,749.2])
Y_BP2 = np.linspace( 1994, 2018, 25)
P_BP2 = np.array( [510.3,503.3,510.2,511.5,517.3,510.1,518.6,531.9,511.2,517.9,503.1,489.4,501.7,521.9,546.1,557.6,575.2,617.4,649.1,655.7,704.7,740.3,727.4,745.8,831.8])
...
ax1.plot( Y_BP1, P_BP1, "-.", lw=3, color='r', label="Добыча в США всего (отчёт ВР 2017 г)")
ax1.plot( Y_BP2, P_BP2, "-", lw=3, color='r', label="Добыча в США всего (отчёт ВР 2019 г)")
...
ax1.errorbar( Year[:-22], sum_HA[:-22], yerr=sum_HA[:-22]*.05, fmt='o', color="k")
