...
ax2.errorbar( Year[:-24], Wells3[:-24]/1000, yerr=.1, fmt='o', color="g", label='На "старых" нефтяных месторождениях')
ax2.errorbar( Year[:-24], Wells2[:-24]/1000, yerr=.1, fmt='o', color="m", label='На "новых сланцевых" месторождениях')
