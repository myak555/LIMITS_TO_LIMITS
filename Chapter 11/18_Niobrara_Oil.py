...
name = "Ниобрара"
data_name = "./Data/US18_Niobrara_Oil.csv"
metric = True
...
YC,PC = Load_Calibration( "./Data/US22_US_Tight_Oil_EIA.csv", "Year", "Niobrara_Codell")
...
if metric:
    ...
    ax1.set_ylabel("Млн boe в сутки")
...
plt.savefig( ".\\Graphs\\figure_11_18.png")
fig.show()
