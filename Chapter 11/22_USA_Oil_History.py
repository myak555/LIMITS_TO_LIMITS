...
Historical_Year, Historical_Production = Load_Calibration( "US_Fossil_Fuel_Reconstructed.csv", "Year", "Oil")
Rig_Year, Rotary_Rigs = Load_Calibration( "US_Rigs_and_Wells.csv", "Year", "Rotary_Rigs")
Rig_Year, Onshore_Rigs = Load_Calibration( "US_Rigs_and_Wells.csv", "Year", "Onshore")
