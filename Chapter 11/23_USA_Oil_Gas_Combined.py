...
Rig_Year, Oil_Wells = Load_Calibration( "US_Rigs_and_Wells.csv", "Year", "Dev_Oil")
Gas_Wells, Dry_Wells = Load_Calibration( "US_Rigs_and_Wells.csv", "Dev_Gas", "Dev_Dry")
Rig_Year, Expl_Wells = Load_Calibration( "US_Rigs_and_Wells.csv", "Year", "Expl_Total")
Footage_Year, Length_Total = Load_Calibration( "US_Well_Footage.csv", "Year", "Total")
Length_Expl, Length_Dev = Load_Calibration( "US_Well_Footage.csv", "Expl_Total", "Prod_Total")
...
print( np.sum(Historical_Oil[149:]+Historical_Gas[149:])/1000)
