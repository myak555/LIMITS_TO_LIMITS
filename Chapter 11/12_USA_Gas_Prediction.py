...
ax1.plot( EIA_Year, EIA_Withdrawals, "-", lw=1, color='r', label="Извлечение всего")
ax1.plot( EIA_Year[:-1], EIA_Extracted[:-1], "-", lw=3, color='r', label="Минус закачка ({:.1f}·10¹² м³)".format(np.sum(EIA_Extracted)/1000))
...
ax2.plot( EIA_Year[67:-1], EIA_OW[67:-1]+EIA_GW[67:-1]+EIA_CBM[67:-1], "-", lw=3, color='k', label='Рудничный газ')
ax2.plot( EIA_Year[67:-1], EIA_GW[67:-1]+EIA_OW[67:-1], "-", lw=3, color='r', label='"Классический" газ')
ax2.plot( EIA_Year[67:-1], EIA_OW[67:-1], "-", lw=2, color='g', label='Попутный газ')
