...
name = "Барнетт"
data_name = "./Data/US01_Barnett_Gas.csv"
metric = True
...
YC,PC = Load_Calibration( "./Data/US12_US_Tight_Gas_EIA.csv", "Year", "Barnett")
...
if metric:
    ...
    ax1.annotate("Пик добычи в ноябре 2011", xy=(2012, 60), xytext=(1995, 80), arrowprops=dict(facecolor='black', shrink=0.05))
else:
...
plt.savefig( ".\\Graphs\\figure_11_01.png")
fig.show()
