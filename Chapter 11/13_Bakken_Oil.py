...
name = "Баккен"
data_name = "./Data/US13_Bakken_Oil.csv"
metric = True
...
YC,PC = Load_Calibration( "./Data/US22_US_Tight_Oil_EIA.csv", "Year", "Bakken")
...
if metric:
    ...
    ax1.annotate("Пик добычи в декабре 2014", xy=(2015, 58), xytext=(2020, 52), arrowprops=dict(facecolor='black', shrink=0.05))
else:
