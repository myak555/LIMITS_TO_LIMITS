...
Oil_1P = Bathtub( 1965, s0=0.2, x1 = 2053.30, s1=0.2, middle=Res.Oil[-1]).GetVector(Year)
Oil_2P = Bathtub( 1965, s0=0.2, x1 = 2059.75, s1=0.2, middle=Res.Oil[-1]).GetVector(Year)
Oil_3P = Bathtub( 1965, s0=0.2, x1 = 2092.02, s1=0.2, middle=Res.Oil[-1]).GetVector(Year)
OGL_1P = Bathtub( 1965, s0=0.2, x1 = 2049.07, s1=0.15, middle=Res.Gas_and_Liquids[-1]).GetVector(Year)
OGL_2P = Bathtub( 1965, s0=0.2, x1 = 2063.93, s1=0.15, middle=Res.Gas_and_Liquids[-1]).GetVector(Year)
OGL_3P = Bathtub( 1965, s0=0.2, x1 = 2085.55, s1=0.15, middle=Res.Gas_and_Liquids[-1]).GetVector(Year)
All_1P = Bathtub( 1965, s0=0.2, x1 = 2061.58, s1=0.125, middle=Res.Total[-1]).GetVector(Year)
All_2P = Bathtub( 1965, s0=0.2, x1 = 2096.91, s1=0.125, middle=Res.Total[-1]).GetVector(Year)
All_3P = Bathtub( 1965, s0=0.2, x1 = 2264.75, s1=0.125, middle=Res.Total[-1]).GetVector(Year)
...
fig.suptitle( 'Модель типа "Снижение добычи по Х% в год"', fontsize=22)
gs = plt.GridSpec(1, 1)
