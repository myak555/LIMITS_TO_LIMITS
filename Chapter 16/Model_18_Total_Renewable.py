...
class Energy_Model_7:
    def __init__( self, Resource, Population, ERoEI, q0, URR=1400e3, staple_level = 1.6):
        ...
        self.Investment_Factor_Carbon = 1.0
        self.Investment_Factor_Renewable = 1.02
        ...
        self.Nuclear.Wavelets += [Sigmoid( 2063, .08, 0, 1550)]
        return
    def Solve( self, t0):
...
fig.suptitle( 'Полная модель энергетики Халла-Клитгаарда', fontsize=22)
...
plt.savefig( "./Graphs/figure_16_18.png")
