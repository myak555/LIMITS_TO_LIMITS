...
class Energy_Model_5:
    def __init__( self, Resource, Population, ERoEI, q0, URR=1000e3, staple_level = 1.4):
...
#plt.xlim( -1, 100)
#plt.legend(loc=0)
#plt.savefig( ".\\Graphs\\figure_16_17a.png")
#fig.show()

x_start, x_end = 1850, 2150

fig = plt.figure( figsize=(15,10))
fig.suptitle( 'Базовая модель энергетики, нижняя оценка населения', fontsize=22)
