...
class Island_Population_3:
    def __init__( self, P0, Q0, O0, F0, T2_P, T2_O, T2_F, d_Q, j_O):
        ...
        self.D = Sigmoid( 150, 0.50, 1, d_Q)
        self.J = Sigmoid( 400, 0.25, j_O, j_O*10)
        return
    def dP_dt( self, t):
        tmp = max ( self.Q, 0.01)
...
plt.ylabel("единиц")
plt.ylim( 0, 10000)
plt.title( "Остров Мальтуса #3 - скорость внедрения технологий х20")
plt.grid(True)
plt.legend(loc=0)
plt.savefig( "./Graphs/figure_05_10.png")
fig.show()
