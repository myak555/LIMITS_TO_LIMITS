...
ax1.plot( BP_Year[:-9], BP_2008P[:-9], "-", lw=2, color='r')
ax1.plot( BP_Year[:-8], BP_2009P[:-8], "-", lw=2, color='g')
ax1.plot( BP_Year[:-7], BP_2010P[:-7], "-", lw=2, color='b')
ax1.plot( BP_Year[:-6], BP_2011P[:-6], "-", lw=2, color='m')
ax1.plot( BP_Year[:-5], BP_2012P[:-5], "-", lw=2, color='k')
ax1.plot( BP_Year[:-3], BP_2014P[:-3], "-", lw=2, color='r')
