...
BP_Year, BP_2008P = Load_Calibration( "09_BP_Hydro.csv", "Year", "2008")
BP_2009P, BP_2010P = Load_Calibration( "09_BP_Hydro.csv", "2009", "2010")
BP_2011P, BP_2012P = Load_Calibration( "09_BP_Hydro.csv", "2011", "2012")
BP_2014P, BP_2015P = Load_Calibration( "09_BP_Hydro.csv", "2014", "2015")
BP_2016P, BP_2017P = Load_Calibration( "09_BP_Hydro.csv", "2016", "2017")
...
fig.suptitle( 'Мировое производство гидроэнергии по отчётам "ВР" 2008-2017 гг', fontsize=22)
...
plt.savefig( ".\\Graphs\\figure_09_10.png")
fig.show()
