...
sigma2 = np.log(2) / 37
sigma3 = np.log(2) / 28
Sequestration_1 = Reagent_Sequestration( Q0, CO2_Scenario_3(), norm, Q0 * sigma1, 0.85)
Sequestration_1.Solve( T)
Sequestration_2 = Reagent_Sequestration( Q0, CO2_Scenario_3(), norm, Q0 * sigma2, 1.0)
Sequestration_2.Solve( T)
Sequestration_3 = Reagent_Sequestration( Q0, CO2_Scenario_3(), norm, Q0 * sigma3, 1.15)
Sequestration_3.Solve( T)

fig = plt.figure( figsize=(15,10))
plt.plot( T, Sequestration_1.Solution_Q, "--", lw=2, color='m', label=" -15% выбросов, T₂=55 лет")
plt.plot( T, Sequestration_2.Solution_Q, "-", lw=2, color='m', label=Sequestration_3.B.Name + ", T₂=37 лет")
plt.plot( T, Sequestration_3.Solution_Q, "-.", lw=2, color='m', label=" +15% выбросов, T₂=28 лет")
