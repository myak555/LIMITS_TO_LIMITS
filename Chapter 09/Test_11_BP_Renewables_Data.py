...
diff_2011 = BP_2011P * 100 / BP_2019P 
diff_2012 = BP_2012P * 100 / BP_2019P 
diff_2014 = BP_2014P * 100 / BP_2019P 
diff_2015 = BP_2015P * 100 / BP_2019P 
diff_2016 = BP_2016P * 100 / BP_2019P 
diff_2017 = BP_2017P * 100 / BP_2019P 
diff_2018 = BP_2018P * 100 / BP_2019P 

fig = plt.figure( figsize=(15,10))
fig.suptitle( 'Мировое производство возобновляемой энергии по отчётам "ВР" 2008-2019 гг', fontsize=22)
gs = plt.GridSpec(2, 1, height_ratios=[3, 1]) 
ax1 = plt.subplot(gs[0])
ax2 = plt.subplot(gs[1])

ax1.plot( BP_Year[26:-8], BP_2011P[26:-8], "--", lw=1, color='m', label="Отчёт 2011 г")
ax1.plot( BP_Year[26:-7], BP_2012P[26:-7], "--", lw=1, color='k', label="Отчёт 2012 г")
...
ax2.plot( BP_Year[26:-8], diff_2011[26:-8], "--", lw=1, color='m')
ax2.plot( BP_Year[26:-7], diff_2012[26:-7], "--", lw=1, color='k')
ax2.plot( BP_Year[:-5], diff_2014[:-5], "-", lw=1, color='r')
ax2.plot( BP_Year[:-4], diff_2015[:-4], "-", lw=1, color='g')
ax2.plot( BP_Year[:-3], diff_2016[:-3], "-", lw=1, color='b')
ax2.plot( BP_Year[:-2], diff_2017[:-2], "-", lw=1, color='m')
