...
EIA_All = np.array( [70306.4,71987.5,74222.8,75682.0,74839.3,
                 ...
                 96744.1,97175.3,95322.7,97846.8])
EIA_OnC = np.array( [62430.3,63818.3,65802.4,67032.8,65967.0,
                     ...
                     80454.7,80578.1,80946.8,82717.9])
...
plt.errorbar( T, EIA_All/1000, yerr=EIA_All*0.00003, fmt='o', color="b", label="Все жидкости (EIA-2019)")
plt.errorbar( T, EIA_OnC/1000, yerr=EIA_OnC*0.00003, fmt='o', color="k", label="Нефть и лицензионный конденсат (EIA-2019)")
