...
diff_2008 = BP_2008P[:-10] * 100 / BP_2018P[:-10] 
diff_2009 = BP_2009P[:-9] * 100 / BP_2018P[:-9] 
diff_2010 = BP_2010P[:-8] * 100 / BP_2018P[:-8] 
diff_2011 = BP_2011P[:-7] * 100 / BP_2018P[:-7] 
diff_2012 = BP_2012P[:-6] * 100 / BP_2018P[:-6] 
diff_2014 = BP_2014P[:-4] * 100 / BP_2018P[:-4] 
diff_2015 = BP_2015P[:-3] * 100 / BP_2018P[:-3] 
diff_2016 = BP_2016P[:-2] * 100 / BP_2018P[:-2] 
diff_2017 = BP_2017P[:-1] * 100 / BP_2018P[:-1] 

fig = plt.figure( figsize=(15,10))
fig.suptitle( 'Мировая добыча нефти и жидкостей по отчётам "ВР" 2008-2018 гг', fontsize=22)
...
ax2.plot( BP_Year[:-10], diff_2008, "--", lw=1, color='r')
ax2.plot( BP_Year[:-9], diff_2009, "--", lw=1, color='g')
ax2.plot( BP_Year[:-8], diff_2010, "--", lw=1, color='b')
ax2.plot( BP_Year[:-7], diff_2011, "--", lw=1, color='m')
ax2.plot( BP_Year[:-6], diff_2012, "--", lw=1, color='k')
ax2.plot( BP_Year[:-4], diff_2014, "-", lw=1, color='r')
ax2.plot( BP_Year[:-3], diff_2015, "-", lw=1, color='g')
ax2.plot( BP_Year[:-2], diff_2016, "-", lw=1, color='b')
ax2.plot( BP_Year[:-1], diff_2017, "-", lw=1, color='b')
