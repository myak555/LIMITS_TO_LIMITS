...
##H3 = Hubbert( 2015, .0435, 0.3, 3200).GetVector( T)
##print( T[100], H3[100], np.sum(H3))

rho_crude = 0.852
rho_gc = 0.720
rho_tar = 0.950

BP_Year, M = Load_Calibration( "01_BP_Oil_Liquids.csv", "Year", "2017")
BP_Year, rho = Load_Calibration( "03_BP_Oil_Density.csv", "Year", "2017")
...
ax1.bar( BP_Year, M_gc, width=0.35, bottom=M_crude, color='#FFD1D2', label="Конденсат и NGPL")
ax1.bar( BP_Year, M_tar, width=0.35, bottom=M_crude+M_gc, color='#CDCDCD', yerr=M*0.05, label="Битум (по данным Министерства Природных Ресурсов Канады, 2016 г)")
