...
Time, Pop  = Load_Calibration( "Randers_2052_OECD.csv", "Year", "Population")
Workforce, Labor_Prod = Load_Calibration( "Randers_2052_OECD.csv", "Workforce", "Labor_Prod")
GDP, Consumption = Load_Calibration( "Randers_2052_OECD.csv", "GDP", "Consumption")
Coal, Oil = Load_Calibration( "Randers_2052_OECD.csv", "Coal", "Oil")
Gas, Nuclear = Load_Calibration( "Randers_2052_OECD.csv", "Gas", "Nuclear")
Renewable, Food = Load_Calibration( "Randers_2052_OECD.csv", "Renewable", "Food")
Land, Yield = Load_Calibration( "Randers_2052_OECD.csv", "Land", "Yield")
...
fig.suptitle( 'Страны OECD, кроме США (предсказание NewWorld 2012 г)', fontsize=22)
