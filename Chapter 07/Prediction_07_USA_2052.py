...
Time, Pop  = Load_Calibration( "Randers_2052_USA.csv", "Year", "Population")
Workforce, Labor_Prod = Load_Calibration( "Randers_2052_USA.csv", "Workforce", "Labor_Prod")
GDP, Consumption = Load_Calibration( "Randers_2052_USA.csv", "GDP", "Consumption")
Coal, Oil = Load_Calibration( "Randers_2052_USA.csv", "Coal", "Oil")
Gas, Nuclear = Load_Calibration( "Randers_2052_USA.csv", "Gas", "Nuclear")
Renewable, Food = Load_Calibration( "Randers_2052_USA.csv", "Renewable", "Food")
Land, Yield = Load_Calibration( "Randers_2052_USA.csv", "Land", "Yield")
