...
ax1.plot( BAU_1972.Time, BAU_1972.Energy, "--", lw=1 , color="r", label="World3: {:.0f} млрд toe".format(np.sum(BAU_1972.Energy)/1e3))
ax1.plot( BAU_2012.Time, BAU_2012.Energy, "-", lw=3, color="r", label="NewWorld: {:.0f} млрд toe".format(np.sum(BAU_2012.Energy)/1e3))
...
ax2.plot( BAU_1972.Time, BAU_1972.Energy_PC*1000, "--", lw=1, color="r", label="World3 - 1972")
ax2.plot( BAU_2012.Time, BAU_2012.Energy_PC*1000, ".", lw=3, color="y", label="Рандерс - 2012")
ax2.plot( BAU_2012.Time, Energy_Per_Capita_UN, "-", lw=1, color="y", label="По демографической модели ООН - 2019")
