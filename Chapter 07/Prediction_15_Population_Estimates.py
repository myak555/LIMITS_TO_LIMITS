...
ax1.plot( BAU_2012_Realistic.Time, UN_Medium, "--", lw=1, color="b", label="Средняя модель ООН - 2019")
ax1.plot( BAU_2012_Realistic.Time, UN_Low, "--", lw=1, color="m", label="Минимальная модель ООН - 2019")
