...
Time, Pop  = Load_Calibration( "Randers_2052_China.csv", "Year", "Population")
Workforce, Labor_Prod = Load_Calibration( "Randers_2052_China.csv", "Workforce", "Labor_Prod")
GDP, Consumption = Load_Calibration( "Randers_2052_China.csv", "GDP", "Consumption")
Coal, Oil = Load_Calibration( "Randers_2052_China.csv", "Coal", "Oil")
Gas, Nuclear = Load_Calibration( "Randers_2052_China.csv", "Gas", "Nuclear")
Renewable, Food = Load_Calibration( "Randers_2052_China.csv", "Renewable", "Food")
Land, Yield = Load_Calibration( "Randers_2052_China.csv", "Land", "Yield")
...
fig.suptitle( 'КНР (предсказание NewWorld 2012 г)', fontsize=22)
