...
Time, Pop  = Load_Calibration( "Randers_2052_BRISE.csv", "Year", "Population")
Workforce, Labor_Prod = Load_Calibration( "Randers_2052_BRISE.csv", "Workforce", "Labor_Prod")
GDP, Consumption = Load_Calibration( "Randers_2052_BRISE.csv", "GDP", "Consumption")
Coal, Oil = Load_Calibration( "Randers_2052_BRISE.csv", "Coal", "Oil")
Gas, Nuclear = Load_Calibration( "Randers_2052_BRISE.csv", "Gas", "Nuclear")
Renewable, Food = Load_Calibration( "Randers_2052_BRISE.csv", "Renewable", "Food")
Land, Yield = Load_Calibration( "Randers_2052_BRISE.csv", "Land", "Yield")
...
ax4.set_ylim( 0, 20)
ax4.legend(loc=0)
plt.savefig( ".\\Graphs\\figure_07_10.png")
fig.show()
