...
T_Ran, Coal_Ran = Load_Calibration( "Randers_2052.csv", "Year", "Coal")
Oil_Ran, Gas_Ran = Load_Calibration( "Randers_2052.csv", "Oil", "Gas")
Pop_Ran, Work_Ran = Load_Calibration( "Randers_2052.csv", "Population", "Workforce")
Oil_Ran += Coal_Ran
Gas_Ran += Oil_Ran
...
plt.errorbar( T_Ran, Coal_Ran, yerr=Coal_Ran*0.03, fmt='o', color="black", label="Кам. уголь (Рандерс)")
plt.errorbar( T_Ran, Oil_Ran, yerr=Oil_Ran*0.03, fmt='o', color="g", label="+ Нефть (Рандерс)")
plt.errorbar( T_Ran, Gas_Ran, yerr=Gas_Ran*0.03, fmt='o', color="r", label="+ Природный газ (Рандерс)")
...
plt.errorbar( T_Ran, Pop_Ran, yerr=Pop_Ran*0.03, fmt='o', color="b", label="Население (Рандерс)")
plt.xlabel("Годы")
plt.xlim( 1800, 2100)
