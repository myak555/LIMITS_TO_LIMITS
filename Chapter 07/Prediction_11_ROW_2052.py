...
Time, Pop  = Load_Calibration( "Randers_2052_ROW.csv", "Year", "Population")
Workforce, Labor_Prod = Load_Calibration( "Randers_2052_ROW.csv", "Workforce", "Labor_Prod")
GDP, Consumption = Load_Calibration( "Randers_2052_ROW.csv", "GDP", "Consumption")
Coal, Oil = Load_Calibration( "Randers_2052_ROW.csv", "Coal", "Oil")
Gas, Nuclear = Load_Calibration( "Randers_2052_ROW.csv", "Gas", "Nuclear")
Renewable, Food = Load_Calibration( "Randers_2052_ROW.csv", "Renewable", "Food")
Land, Yield = Load_Calibration( "Randers_2052_ROW.csv", "Land", "Yield")
...
fig.suptitle( 'Остальные страны (предсказание NewWorld 2012 г)', fontsize=22)
...
ax4.set_ylim( 0, 20)
ax4.legend(loc=0)
plt.savefig( ".\\Graphs\\figure_07_11.png")
fig.show()
