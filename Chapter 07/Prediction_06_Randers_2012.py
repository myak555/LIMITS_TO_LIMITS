...
Food_Per_Capita_UN = BAU_2012.Food * 1000 / UN_Med

fig = plt.figure( figsize=(15,15))
fig.suptitle( 'Сельское хозяйство NewWorld 2012 г', fontsize=22)
gs = plt.GridSpec(2, 1, height_ratios=[2, 1]) 
ax1 = plt.subplot(gs[0])
ax2 = plt.subplot(gs[1])

ax1.plot( BAU_2012.Time, BAU_2012.Food, "-", lw=2, color="g")
ax1.plot( BAU_2012.Time, BAU_2012.Yield*1000, "-", lw=1, color="m")
ax1.plot( BAU_2012.Time, BAU_2012.Land, "-", lw=1, color="k")
...
ax2.plot( BAU_1972.Time, BAU_1972.Food_PC*1000, "--", lw=1, color="r", label="Продовольствие на душу населения (World3)")
ax2.plot( BAU_2012.Time, BAU_2012.Food_PC*1000, ".", lw=3, color="y", label="Продовольствие на душу населения (Рандерс)")
ax2.plot( BAU_2012.Time, Food_Per_Capita_UN, "-", lw=1, color="y", label="Продовольствие на душу населения (ООН)")
