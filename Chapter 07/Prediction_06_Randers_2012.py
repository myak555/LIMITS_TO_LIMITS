...
ax2.plot( BAU_2012.Time, BAU_2012.Food_PC*1000, ".", lw=3, color="y", label="Рандерс - 2012")
ax2.plot( BAU_2012.Time, Food_Per_Capita_UN, "-", lw=1, color="y", label="По демографической модели ООН - 2019")
