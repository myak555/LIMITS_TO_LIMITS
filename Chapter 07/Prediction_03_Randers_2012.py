...
plt.plot( T[125:], UN_Med[125:], "-", lw=2, color="g", label="Средняя оценка ООН - 2019")
plt.plot( T[100:], Difference[100:], "--", lw=2, color="r", label="Разница ООН-Рандерс")
plt.errorbar( Time_Ran, Population_Ran, fmt='o', color="b")
plt.errorbar( P0.Calibration_Year, P0.Calibration_Total, yerr=P0.Calibration_Yerr, fmt='.', color="k",
              label="Статистика ООН - 2019")
