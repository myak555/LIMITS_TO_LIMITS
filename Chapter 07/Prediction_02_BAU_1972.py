...
fig.suptitle( 'Предсказания базового сценария World-3 (1972 г)', fontsize=22)
...
ax1.plot( T0, BAU_1972.Population/1000, "-", lw=2, color="b", label="World-3")
...
ax2.plot( T0, BAU_1972.Resources/1e6, "-", lw=2, color="m", label="World-3")
...
ax3.errorbar( FAO_Year, FAO_Net_Food/850, fmt='.', color="k", label="Статистика (ФАО)")
...
ax4.plot( T0, BAU_1972.CO2/1000, "-", lw=2, color="y", label="World-3")
