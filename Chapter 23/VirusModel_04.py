...
VS1 = VirusSpread2(0.25, 1200, Rho_function, Phi_function, r, r, P)
VS1.InitiallyInfected = 50
VS2 = VirusSpread3(0.25, 1200, Rho_function, Phi_function, TmN_function, TmS_function, P)
...
fig.suptitle( 'Нелетальный вирус, превентивное дистанцирование', fontsize=22)
...
if True:
    ...
    ax1.grid(True)
    ax1.legend(loc=0)
    plt.savefig( "./Graphs/figure_23_04a.png")
