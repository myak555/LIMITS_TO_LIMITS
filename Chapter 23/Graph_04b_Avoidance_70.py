...
VS1 = VirusSpread2(0.1, 6000, Rho_function, Phi_function, r, P)
VS2 = VirusSpread3(0.1, 6000, Rho_function, Phi_function, rN, rS, P)
#VS1.Integrate()
VS2.Integrate()
...
fig.suptitle( 'Нелетальный вирус, изоляция 50% больных', fontsize=22)
