...
TmN_function = Bathtub( x0=110.0, s0=1.0, x1 = 140.0, s1=1.0, left=r, middle=rN, right=r)
TmS_function = Bathtub( x0=115.0, s0=0.3, x1 = 140.0, s1=0.5, left=r, middle=rN, right=rS)
#TmS_function = Sigmoid( x0=115.0, s0=0.05, left=r, right=rS)

VS1 = VirusSpread2(0.25, 8000, Rho_function, Phi_function, r, r, P)
VS1.InitiallyInfected = 50
VS2 = VirusSpread3(0.25, 8000, Rho_function, Phi_function, TmN_function, TmS_function, P)
