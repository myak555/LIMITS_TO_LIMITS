...
class VirusSpread3:
    ...
    def Integrate(self):
        ...
        for i in range(1,L):
            # compute infected
            self.dI[i] = (self.SheddingN[i] * self.rN + self.SheddingS[i] * self.rS) \
...
VS2 = VirusSpread3(0.05, 12000, Rho_function, Phi_function, rN, rS, P)
VS1.Integrate()
VS2.Integrate()
...
fig.suptitle( 'Эпидемия "фиолетовой лихорадки" - изоляция 30% больных', fontsize=22)
...
ax1.plot( VS1.time, VS1.Infected*1e-9, "--", lw=2, color='g', label="Решение для r=Const")
ax1.plot( VS1.time, VS1.Recovered*1e-9, "--", lw=2, color='y')
ax1.plot( VS1.time, VS1.Shedding*1e-9, "--", lw=2, color='r')
ax1.plot( VS1.time, VS1.Symptomatic*1e-9, "--", lw=2, color='m')

ax1.plot( VS2.time, VS2.Infected*1e-9, "-", lw=3, color='g', label="Инфицированные")
ax1.plot( VS2.time, VS2.Recovered*1e-9, "-", lw=3, color='y', label="Переболевшие")
ax1.plot( VS2.time, VS2.SheddingN*1e-9, "-", lw=3, color='r', label="Заразные (без симптомов)")
ax1.plot( VS2.time, VS2.SheddingS*1e-9, "-", lw=3, color='k', label="Заразные (с симптомами)")
ax1.plot( VS2.time, VS2.Symptomatic*1e-9, "-", lw=3, color='m', label="Больные с симптомами")
...
ax2.plot( VS1.time, VS1.dI*1e-6, "--", lw=2 , color='g',label="Решение для r=Const")
ax2.plot( VS1.time, VS1.dS*1e-6, "--", lw=2, color='m')
ax2.plot( VS2.time, VS2.dI*1e-6, "-", lw=3, color='g',label="Заразились")
ax2.plot( VS2.time, VS2.dS*1e-6, "-", lw=3, color='m', label="Заболели")
...
plt.savefig( "./Graphs/figure_23_06.png")
