...
plt.plot( P1.Solution_Time, P1.Solution_P, "-", lw=1, label="Сигмоида")
plt.plot( P2.Solution_Time, P2.Solution_P, "-", lw=1, label="Пик и стабилизация")
plt.plot( P3.Solution_Time, P3.Solution_P, "-", lw=1, label="Осцилляция")
plt.plot( T, P4, "--", lw=1, label="Оптимальный уровень")
plt.xlabel("Годы")
plt.xlim( 1600, 2000)
plt.ylabel("единиц")
plt.ylim( 0, 2000)
plt.title( "Пруд Мальтуса #3 - Осциллирующая популяция (T2=10).")
plt.grid(True)
plt.legend(loc=0)
