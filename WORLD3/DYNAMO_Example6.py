...
#
# Population a function of LEB and TFR check
#
...
#PlotTable( DYNAMO_Engine, Mortality0To14, 0, 100, "LifeExpectancy [years]", show=True)
...
Mortality15To44 = TableParametrization(
    ...
    20, 80, "deaths / person / year",
    fupdate = "_019_LifeExpectancy.K")
#PlotTable( DYNAMO_Engine, Mortality15To44, 0, 100, "LifeExpectancy [years]", show=True)
...
Mortality45To64 = TableParametrization(
    ...
    20, 80, "deaths / person / year",
    fupdate = "_019_LifeExpectancy.K")
#PlotTable( DYNAMO_Engine, Mortality45To64, 0, 100, "LifeExpectancy [years]", show=True)
...
Mortality65AndOver = TableParametrization(
    ...
    fupdate = "_019_LifeExpectancy.K")
#PlotTable( DYNAMO_Engine, Mortality65AndOver, 0, 100, "LifeExpectancy [years]", show=True)
...
Females20to40Ratio  = TableParametrization(
    ...
    1950, 2020,
    fupdate = "DYNAMO_Engine.time")
#PlotTable( DYNAMO_Engine, Females20to40Ratio, 1900, 2100, "Time [years]", show=True)
...
PlotTable( DYNAMO_Engine, AverageFertilityPeriod, 0, 6, "TFR [children per woman]", show=True)
...
#PlotTable( DYNAMO_Engine, AverageFertilityPeriod, 0, 10, "TFR [unitless]", show=True)
...
#          lw=2, color="b", alpha=0.5, label='"World-3" 2003')
