...
year_Ch, LEB_Ch, CBR_Ch, CDR_Ch, Pop_Ch, TFR_Ch = clb("./Data/Demographics_Checks.csv",
        ["Time", "_019_LifeExpectancy",
         "_031_CrudeBirthRate", "_018_CrudeDeathRate",
         "_001_Population", "_032_TotalFertility"])
#_002_Population0To14,_006_Population15To44,_010_Population45To64,_014_Population65AndOver,
...
ax1.plot( year_BH, Pop_BH/1e3, "--",
          lw=2, color="b", alpha=0.5, label='"World-3" 2003 in JS by Brian Hayes')
#ax1.plot( year_Ch, Pop_Ch/1e9, ".",
#          lw=2, color="b", alpha=0.3, label='"World-3" 2003 in Python by Mike Yakimov')
...
#ax2.plot( year_Ch, LEB_Ch, ".", lw=2, color="m", alpha=0.3)
ax2.plot( year_Ch, TFR_Ch*10, "--", lw=2, color="g", alpha=0.5)
...
#ax3.plot( year_Ch, CBR_Ch, ".", lw=2, color="g", alpha=0.3)
#ax3.plot( year_Ch, CDR_Ch, ".", lw=2, color="r", alpha=0.3)
...
plt.savefig( "./Calibrations/Calibration_02.png")
plt.show()
